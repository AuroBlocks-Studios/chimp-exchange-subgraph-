...
export const assets: Assets = {
  stableAssets: [
    ...
    Address.fromString('0xd0247D417434b83b9246a878335Ca192Ab2F6b53'), // Linea USDT
    Address.fromString('0x8042bAf687c2342930558806e8E6A2B946B22a22'), // Linea USDC
    Address.fromString('0xc9F5882B1F513AE962FEf465900F1ADB0703B6fa'), // Linea DAI
  ],
  pricingAssets: [
    ...
    Address.fromString('0x2C1b868d6596a18e32E61B901E4060C872647b6C'), // Linea WETH
  ],
  fxAssets: [
    Address.fromString('0xA0b86991c6218b36c1d19D4a2e9Eb0cE3606eB48'), // USDC
